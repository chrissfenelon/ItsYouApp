    ...
    <aside className="w-64 min-h-screen glass border-r border-white/10 p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-white">ItsYouApp</h2>
      ...
      <div className="mt-auto pt-6 border-t border-white/10">
        <Link
          href="/"
          className="flex items-center space-x-3 px-4 py-3 rounded-lg text-red-400 hover:text-red-300 hover:glass-input transition-all duration-200"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
